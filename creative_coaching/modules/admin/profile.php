...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    <html>
    <head>
        <title><?php echo $name ?>-Creative Academic Care</title>
        ...
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-4 col-xs-12 col-sm-6 col-lg-4">
                    <img src="images/shopna.jpg" alt="stack photo" class="img" height="200" width = "200">
                </div>
                <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                    ...
                    <ul class="container details">
                        <li><p><span class="glyphicon glyphicon-ok-sign" style="width:50px;"></span><?php echo 'User Name: '.$eid.' (Admin)'; ?></p></li>
                        ...
                        <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span><?php echo strtoupper($address) ?></p></li>
